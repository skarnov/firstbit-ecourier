    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>"><b>1stbit</b><br/> E - Courier Login </a>
            </div>
            <div class="login-box-body">
                <form action="<?php echo base_url(); ?>admin_login/check_admin_login" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <a href="<?php echo base_url();?>admin_login/forgot_password" class="btn btn-default btn-block btn-flat">Forgot Password</a>
                        </div>
                    </div>
                </form>
            </div>
