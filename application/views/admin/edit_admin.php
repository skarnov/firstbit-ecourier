<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo base_url(); ?>ecommerce/update_admin" method="POST" name="admin">
                        ...
                        <div class="col-xs-8">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="admin_level" value="<?php echo $admin_info->admin_level; ?>">
                                    <input type="hidden" name="admin_status" value="<?php echo $admin_info->admin_status; ?>">
                                    <input type="hidden" name="admin_type" value="<?php echo $admin_info->admin_type; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
