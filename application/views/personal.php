<div class="row">
    <ul class="breadcrumb">
        ...
        <li><a href="">Personal Delivery Form</a></li>
    </ul>
    <div class="col-md-12">
        ...
        <form id="defaultForm" method="POST" class="form-horizontal" action="<?php echo base_url(); ?>courier/save_personal_delivery">
            <div class="col-md-12">
                <div class="col-md-6">
                    <legend>Your Information</legend>
                    <div class="form-group">
                        <label class="col-md-4">Your Name <span class="required">*</span></label>
                        <div class="col-md-8">
                            <input type="text" name="user_name" placeholder="Your Name/Your Companies Name" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4">Your Address <span class="required">*</span></label>
                        <div class="col-md-8">
                            <input type="text" name="user_address" placeholder="Your Address/Your Companies Address" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4">Your Email Address <span class="required">*</span></label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4">Your Mobile number <span class="required">*</span></label>
                        <div class="col-md-8">
                            <input type="tel" name="user_mobile" placeholder="Your Mobile number" class="form-control">
                        </div>
                    </div>
                </div>    
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label class="control-label">
                                <input type="radio" name="delivery_time" value="72"> Within 72 Hour
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
